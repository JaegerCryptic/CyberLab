        ...
        >
            ...
            >
                ...
                {!gameStarted && !gameWon ? (
                    <Button
                        variant='contained'
                        sx={{ backgroundColor: customTheme.primary, color: customTheme.text }}
                        onClick={startGame}
                    >
                        Start Game
                    </Button>
                    ...
                    <>
                        ...
                        >
                            {filteredFiles.map((file) => (
                                ...
                                >
                                    <ListItemText primary={file.name} sx={{ color: customTheme.text }} />
                                </ListItem>
                            ))}
                        </List>
                        {selectedFile && (
                            ...
                            >
                                <Typography variant='body1' component='div' sx={{ color: customTheme.text }}>
                                    <strong>{selectedFile.name}</strong>
                                </Typography>
                                <Typography variant='body2' component='div' sx={{ color: customTheme.textSecondary }}>
                        ...
                        <Button
                            variant='contained'
                            fullWidth
                            sx={{ marginTop: "16px", backgroundColor: customTheme.primary, color: customTheme.text }}
                        ...
                        {foundInfo && (
                            <Typography
                                variant='body1'
                                component='div'
                                sx={{ marginTop: "16px", wordBreak: "break-all", color: customTheme.text }}
                            >
                                {foundInfo}
                            </Typography>
                        )}
