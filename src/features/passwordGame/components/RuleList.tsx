  ...
  return (
    ...
    >
      {sortedRules.map((rule) => {
        ...
        const bgColor = rule.met ? theme.palette.success.dark : theme.palette.error.light;
            ...
            <Box sx={{ width: '100%' }}>
              <ListItem sx={{ mb: theme.spacing(2), padding: 0 }}>
                ...
                >
                  ...
                  <Typography variant="body1" sx={{ color: theme.palette.text.primary, mt: theme.spacing(1) }}>
                    {rule.text}
                  </Typography>
                </Box>
              </ListItem>
